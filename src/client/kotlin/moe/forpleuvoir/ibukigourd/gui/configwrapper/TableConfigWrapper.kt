...
fun <T> TableWidget.Scope.ColumnBuilder<T>.MoveableTableColumCell(
    ...
    cell: TableLayoutColumnScope.(Int, T) -> IGWidget = { index, _ ->
        Row {
...
fun <T> WidgetContainerScope.TableWrappedButton(
    ...
    content: ButtonScope.() -> Unit = {
        TextLabel(mutableStateBy { IGLang.listConfigWrapperText(userData.count()) })
    },
...
fun <T> WidgetContainerScope.TableConfigListWrappedButton(
    ...
    modifier: Modifier = Modifier,
    content: ButtonScope.() -> Unit = {
        TextLabel(mutableStateBy { IGLang.listConfigWrapperText(config.size) })
    },
    dialogModifier: Modifier = Modifier,
    dialogContentModifier: ColumnScope.() -> Modifier = { Modifier },
    //RowList
...
fun <V> TableScope<Map.Entry<String, V>>.TableConfigMapStringKeyColumn(
    ...
    keyWrapper: ButtonScope.(String, V, Map<String, V>) -> Unit = { k, v, map ->
        TextLabel(k, modifier = Modifier.width(120f))
    },
    keyEditorWrapper: ColumnScope.(String, V, Map<String, V>, (String) -> Unit) -> (() -> Transform) = { k, v, map, setKey ->
...
fun <K> TableScope<Map.Entry<K, String>>.TableConfigMapStringValueColumn(
    ...
    valueEditorWrapper: ColumnScope.(K, String, Map<K, String>, (String) -> Unit) -> Unit = { k, v, map, setValue ->
...
fun <K, V> WidgetContainerScope.TableConfigMapWrappedButton(
    ...
    modifier: Modifier = Modifier,
    content: ButtonScope.() -> Unit = {
        TextLabel(mutableStateBy { IGLang.listConfigWrapperText(config.getValue().size) })
    },
    dialogModifier: Modifier = Modifier,
    dialogContentModifier: ColumnScope.() -> Modifier = { Modifier },
    //RowList
...
fun WidgetContainerScope.StringPairListConfigWrapper(
    ...
    Row(
        ...
        TableConfigListWrappedButton(
            ...
            hoverTableScope = {
                Header {
                    TextLabel(firstTableName, modifier = Modifier.align(Alignment.CenterLeft))
                }.Column {
                    TextLabel(it.first.take(60), modifier = Modifier.align(Alignment.CenterLeft).minWidth(80f).maxWidth(160f))
                }

                Header {
                    TextLabel(secondTableName, modifier = Modifier.align(Alignment.CenterLeft))
                }.Column {
                    TextLabel(it.second.take(60), modifier = Modifier.align(Alignment.CenterLeft).minWidth(80f).maxWidth(160f))
                }
            }
        ) {
...
fun WidgetContainerScope.StringListConfigWrapper(
    ...
    Row(
        ...
        TableConfigListWrappedButton(
            ...
            hoverTableScope = {
                ColumnBuilder {
                    TextLabel(it.take(120), modifier = Modifier.align(Alignment.CenterLeft).minWidth(80f).maxWidth(160f))
                }
            }
        ) {
            val recompose = { this@TableConfigListWrappedButton.executeRecompose() }
    ...
    Row(
        ...
        TableConfigMapWrappedButton(
            ...
            hoverTableScope = {
                ...
                Header {
                    TextLabel(valueTableName, modifier = Modifier.align(Alignment.CenterLeft))
                }.Column {
                    TextLabel(it.value.take(60), modifier = Modifier.align(Alignment.CenterLeft).minWidth(20f).maxWidth(100f))
                }
            }
        ) {
