...
open class MouseHoverTip(
    ...
    padding: moe.forpleuvoir.ibukigourd.gui.base.Margin = PADDING,
    margin: moe.forpleuvoir.ibukigourd.gui.base.Margin = MARGIN,
    var backgroundColor: ARGBColor = Theme.TIP.BACKGROUND_COLOR,
    /**
     * 可显示的方向,会自动选择一个可用的方向
     */
    var optionalDirections: Iterable<moe.forpleuvoir.ibukigourd.gui.base.Direction> = moe.forpleuvoir.ibukigourd.gui.base.Direction.entries
    ...
    protected open var direction: moe.forpleuvoir.ibukigourd.gui.base.Direction = optionalDirections.first()
        set(value) {
    ...
    protected open fun checkDirection() {
        ...
        val canPlace: (moe.forpleuvoir.ibukigourd.gui.base.Direction) -> Boolean = { dir ->
            when (dir) {
...
inline fun Element.hoverTip(
    ...
    optionalDirections: Iterable<moe.forpleuvoir.ibukigourd.gui.base.Direction> = moe.forpleuvoir.ibukigourd.gui.base.Direction.entries,
