...
abstract class AbstractElement : Element {
	...
	override fun onMouseDragging(mouseX: Number, mouseY: Number, button: Int, deltaX: Number, deltaY: Number): NextAction {
		if (!active) return NextAction.Continue
		for (element in handleTree) {
	...
	override var mouseDragging: (mouseX: Number, mouseY: Number, button: Int, deltaX: Number, deltaY: Number) -> NextAction = ::onMouseDragging
