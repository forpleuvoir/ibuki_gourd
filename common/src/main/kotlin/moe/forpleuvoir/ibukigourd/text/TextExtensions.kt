...
val KClass<out Event>.translateText: MutableText get() = Translatable("event.$eventName", eventSimpleName)

val KClass<out Event>.translateComment: MutableText get() = Translatable("event.$eventName.comment", eventSimpleName)