...
import com.forpleuvoir.nebula.config.impl.TomlConfigManagerSerializer
import com.forpleuvoir.nebula.config.item.impl.ConfigString
import com.forpleuvoir.nebula.event.EventSubscriber

@ModConfig("config")
@EventSubscriber
object IbukiGourdServerConfig : ServerModConfigManager(IbukiGourd.MOD_ID, "config"), TomlConfigManagerSerializer {
