 ...
 */
fun pointsInCircle(x0: Int, y0: Int, radius: Int, vararg octant: Int = intArrayOf(1, 2, 3, 4, 5, 6, 7, 8)): Set<IntOffset> {
    ...
    while (y <= x) {
        if (1 in octant) points.add(IntOffset(x + x0, y + y0)) // Octant 1
        if (2 in octant) points.add(IntOffset(y + x0, x + y0)) // Octant 2
        if (3 in octant) points.add(IntOffset(-y + x0, x + y0)) // Octant 3
        if (4 in octant) points.add(IntOffset(-x + x0, y + y0)) // Octant 4
        if (5 in octant) points.add(IntOffset(-x + x0, -y + y0)) // Octant 5
        if (6 in octant) points.add(IntOffset(-y + x0, -x + y0)) // Octant 6
        if (7 in octant) points.add(IntOffset(x + x0, -y + y0)) // Octant 7
        if (8 in octant) points.add(IntOffset(y + x0, -x + y0)) // Octant 8
...
private val pointsInCircleCache = LinkedHashMap<PointsInCircleData, Set<IntOffset>>(pointsInCircleCacheSize)
 ...
 */
fun pointsInCircleRange(x0: Int, y0: Int, radius: Int, angleRange: ClosedFloatingPointRange<Double>): Set<IntOffset> {
    ...
    while (y <= x) {
        sequenceOf(
            IntOffset(x + x0, y + y0), // Octant 1
            IntOffset(y + x0, x + y0), // Octant 2
            IntOffset(-x + x0, y + y0), // Octant 4
            IntOffset(-y + x0, x + y0), // Octant 3
            IntOffset(-x + x0, -y + y0), // Octant 5
            IntOffset(-y + x0, -x + y0), // Octant 6
            IntOffset(x + x0, -y + y0), // Octant 7
            IntOffset(y + x0, -x + y0)  // Octant 8
        ).filter {
...
private val pointsInCircleRangeCache = LinkedHashMap<PointsInCircleRangeCacheData, Set<IntOffset>>(pointsInCircleRangeCacheSize)