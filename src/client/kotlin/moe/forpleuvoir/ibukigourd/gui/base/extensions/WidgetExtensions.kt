...
inline fun Widget.mouseHovered(mouseX: Number, mouseY: Number): Boolean {
    return mouseX.toDouble() in left.toDouble()..right.toDouble() && mouseY.toDouble() in top.toDouble()..bottom.toDouble()
}
