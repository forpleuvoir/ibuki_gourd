...
val Icons.HighlightKeyboardFocus: ImageVector
    get() {
        if (highlightKeyboardFocus != null) {
            return highlightKeyboardFocus!!
        }
...
private var highlightKeyboardFocus: ImageVector? = null