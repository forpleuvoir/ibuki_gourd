...
//val KClass<out Event<*>>.translateText: MutableText get() = Translatable("event.${this.jvmName}")
//
//val KClass<out Event<*>>.translateComment: MutableText get() = Translatable("event.${this.jvmName}.comment")
