...
@ModConfig("test")
object TestConfig : ClientModConfigManager(IbukiGourd.MOD_ID, "${IbukiGourd.MOD_ID}_test") {
    ...
    var testDuration by duration("test_duration", 30.seconds, 0.seconds, 60.seconds)

    var testKeyBind by keyBind("test_key_bind", KeyBind {
        println("按下了测试按键")
    })

    var testKeyBindBoolean by keyBindBoolean("test_key_bind_boolean", false, KeyBind(Keyboard.H))
