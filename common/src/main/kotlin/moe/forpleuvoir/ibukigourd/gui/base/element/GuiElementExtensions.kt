...
val GuiElement.parentChain get() = generateSequence(this) { if (it.parent() != it) it.parent() else null }
 ...
 */
fun GuiElement.isInParentChain(target: GuiElement, self: Boolean = true): Boolean {
 ...
 */
fun GuiElement.findFirsInParentChain(self: Boolean = true, predicate: (GuiElement) -> Boolean): GuiElement? {
 ...
 */
fun GuiElement.findLastInParentChain(self: Boolean = true, predicate: (GuiElement) -> Boolean): GuiElement? {
