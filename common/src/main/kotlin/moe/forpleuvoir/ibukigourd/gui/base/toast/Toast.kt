...
import moe.forpleuvoir.ibukigourd.gui.base.toast.Toast.Config.FADE_IN_DURATION
import moe.forpleuvoir.ibukigourd.gui.base.toast.Toast.Config.FADE_IN_OFFSET
import moe.forpleuvoir.ibukigourd.gui.base.toast.Toast.Config.FADE_OUT_DURATION
...
object Toast : Tickable {
    ...
    private val BoxWidget.fadeInDuration: Duration get() = userData["#toast_duration_fade_in"] as? Duration ?: FADE_IN_DURATION
    private val BoxWidget.fadeOutDuration: Duration get() = userData["#toast_duration_fade_out"] as? Duration ?: FADE_OUT_DURATION
