...
class TextAreaWidget(
    ...
    var textColor: ARGBColor = Color.ofRGB(0x303030),
    var hintColor: ARGBColor = Color.ofRGB(0x707070),
    var bgShaderColor: ARGBColor = Colors.WHITE,
    var selectedColor: ARGBColor = Color.ofRGB(0x007F8F).alpha(0.45f),
    var suggestionColor: ARGBColor = Color.ofRGB(0x008F72).alpha(0.45f),
...
fun ContainerScope.TextArea(
    ...
    selectedColor: ARGBColor = Color.ofRGB(0x007F8F).alpha(0.45f),
    suggestionColor: ARGBColor = Color.ofRGB(0x008F72).alpha(0.45f),
