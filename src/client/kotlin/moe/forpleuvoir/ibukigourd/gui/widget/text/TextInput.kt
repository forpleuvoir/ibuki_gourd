...
//            cursor = textRenderer.trimToWidth(string, (mouseX - this.transform.left + 3).toInt()).length + firstCharacterIndex
//        }
...
//        selecting = true
//        val string = textRenderer.trimToWidth(text.substring(firstCharacterIndex), contentWidth.toInt())
//        cursor = textRenderer.trimToWidth(string, (mouseX - this.transform.left + 3f).toInt()).length + firstCharacterIndex
//        selecting = InputHandler.hasKeyPressed(Keyboard.LEFT_SHIFT)
//    }
//
