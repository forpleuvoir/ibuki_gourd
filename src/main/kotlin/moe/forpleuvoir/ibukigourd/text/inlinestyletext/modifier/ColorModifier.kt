...
object ColorModifier : TextModifier {
    ...
    private fun parseColor(exp: String, shadow: Boolean): ((MutableText) -> MutableText)? {
    ...
    private fun parseRGBColor(exp: String, shadow: Boolean): ((MutableText) -> MutableText)? {
        //&{#FF66CC}
    ...
    private fun parseHSVColor(exp: String, shadow: Boolean): ((MutableText) -> MutableText)? {
        //&{[360 100 20]}
    ...
    private fun <C : ARGBColor> gradientText(content: MutableText, start: C, end: C, shadow: Boolean = false): MutableText {
        return Text {
