...
//     * 单页高度
//     */
//    private val contentHeight: Float get() = (height - padding.height).toFloat()
//
//    /**
//     * 文本总高度
//     */
...
//        screen().let {
//            if (!moe.forpleuvoir.ibukigourd.gui.base.mouseHoverContent(it.preMousePosition) && mouseHoverContent(it.mousePosition)) {
//                mouseMoveIn(mouseX, mouseY)
//            } else if (moe.forpleuvoir.ibukigourd.gui.base.mouseHoverContent(it.preMousePosition) && !mouseHoverContent(it.mousePosition)) {
