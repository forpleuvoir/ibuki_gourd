...
object IconTextures : SimpleResourceReloaderListener<SerializeObject>() {
    ...
    private val TEXTURE_INFO_RESOURCES = resourceLocation("texture/gui/ibukigourd_icon.json")

    private val TEXTURE_RESOURCES = resourceLocation("texture/gui/ibukigourd_icon.png")

    private val TEXTURE_INFO = TextureInfo(256, 256, TEXTURE_RESOURCES)

    val RESOURCE_ID = resourceLocation("icon")
